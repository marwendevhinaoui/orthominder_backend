# Generated by Django 5.2 on 2025-05-10 23:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_code', models.IntegerField(validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(9999)])),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patients', to='backend_app.doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='backend_app.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Aligner',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aligners', to='backend_app.patient')),
            ],
        ),
        migrations.CreateModel(
            name='SuperAdmin',
